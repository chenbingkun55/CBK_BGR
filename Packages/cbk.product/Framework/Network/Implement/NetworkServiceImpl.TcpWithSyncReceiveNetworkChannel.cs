        ...
        private sealed class TcpWithSyncReceiveNetworkChannel : NetworkChannelBase
        {
            ...
            public override void Connect(IPAddress ipAddress, int port, object userData)
            {
                ...
                if (m_Socket == null)
                {
                    ...
                    {
                        NetworkChannelError(this, (int)FrameworkErrorCode.NetworkSocketError, SocketError.Success, errorMessage);
                        return;
                    }
            ...
            private void ConnectAsync(IPAddress ipAddress, int port, object userData)
            {
                ...
                catch (Exception exception)
                {
                    if (NetworkChannelError != null)
                    {
                        ...
                        NetworkChannelError(this, (int)FrameworkErrorCode.NetworkConnectError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return;
                    }
            ...
            {
                var socketUserData = (ConnectState)ar.AsyncState;
                try
                {
            ...
            private void SendAsync()
            {
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        var socketException = exception as SocketException;
                        NetworkChannelError(this, (int)FrameworkErrorCode.NetworkSendError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return;
                    }
            ...
            private bool ReceiveSync()
            {
                try
                {
                    var bytesReceived = m_Socket.Receive(m_ReceiveState.Stream.GetBuffer(), (int)m_ReceiveState.Stream.Position, (int)(m_ReceiveState.Stream.Length - m_ReceiveState.Stream.Position), SocketFlags.None);
                    if (bytesReceived <= 0)
                    {
                        Close();
                        return false;
                ...
                catch (Exception exception)
                {
                    ...
                    {
                        var socketException = exception as SocketException;
                        NetworkChannelError(this, (int)FrameworkErrorCode.NetworkReceiveError, socketException != null ? socketException.SocketErrorCode : SocketError.Success, exception.ToString());
                        return false;
                    }
