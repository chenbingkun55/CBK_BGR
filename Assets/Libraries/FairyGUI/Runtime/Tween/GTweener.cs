...
namespace FairyGUI
{
    ...
    public class GTweener
    {
        ...
        bool _invalidateBatchingEveryFrame;
        ...
        public GTweener EnableInvalidateBatchingEveryFrame()
        {
            _invalidateBatchingEveryFrame = true;
            return this;
        }
        ...
        internal GTweener _To(int start, int end, float duration)
        {
            _valueSize = 7;
            _startValue.i = start;
            _endValue.i = end;
        ...
        internal void _Reset()
        {
            ...
            _invalidateBatchingEveryFrame = false;
        }
        ...
        void Update()
        {
            ...
            else if (_valueSize == 7)
            {
                var f = _startValue.i + (_endValue.i - _startValue.i) * _normalizedTime;
                var i = Mathf.RoundToInt(f);
                _deltaValue.i = i - _value.i;
                _value.i = i;
                _value.x = i;
            }
            else if (_path != null)
            ...
            if (_target != null && _propType != TweenPropType.None)
            {
                ...
                switch (_propType)
                {
                    ...
                    case TweenPropType.RotationY:
                        if (_invalidateBatchingEveryFrame && target is GObject gObject)
                            gObject.InvalidateBatchingState();
                        break;
                    case TweenPropType.Alpha:
                    case TweenPropType.Progress:
                    case TweenPropType.NumText:
                    default:
                        break;
                }
            }
