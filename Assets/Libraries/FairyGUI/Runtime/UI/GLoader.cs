...
namespace FairyGUI
{
    ...
    public class GLoader : GObject, IAnimationGear, IColorGear
    {
        ...
        protected internal override void HandleVisibleChanged()
        {
            ...
            if (_content2 != null)
                _content2.HandleVisibleChanged();
        }
        ...
        {
            _content.visible = _content2 == null;
        ...
        override public void Setup_BeforeAdd(ByteBuffer buffer, int beginPos)
        {
            ...
            SetupFlipFromCustomProperty();
        }

        private void SetupFlipFromCustomProperty()
        {
            const string Key = "loader_flip";
            
            var property = GetCustomIntProperty(Key);
            if (property <= 0)
                return;
            
            flip = (FlipType)property;
        }
    }
}
