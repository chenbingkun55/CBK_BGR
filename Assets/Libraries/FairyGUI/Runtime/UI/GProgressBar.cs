...
namespace FairyGUI
{
    ...
    public class GProgressBar : GComponent
    {
        ...
        EventListener _onMinChanged;
        EventListener _onMaxChanged;
        ...
        public EventListener onMinChanged => _onMinChanged ??= new EventListener(this, "onMinChanged");
        public EventListener onMaxChanged => _onMaxChanged ??= new EventListener(this, "onMaxChanged");
        public EventListener onValueChanged => _onValueChanged ??= new EventListener(this, "onValueChanged");
