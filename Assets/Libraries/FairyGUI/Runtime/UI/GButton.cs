...
namespace FairyGUI
{
    ...
    public class GButton : GComponent, IColorGear
    {
        ...
        /// 默认为false(仅在状态变更时播放)
        /// </summary>
        public bool playDownEffectWhileTouch;
        ...
        public GButton()
        {
            ...
            _title = string.Empty;
            playDownEffectWhileTouch = false;
        }
        ...
        private void PlayDownEffect()
        {
            ...
            else if (_downEffect == 2)
            {
                ...
                {
                    _downScaled = true;
                    if (UIConfig.buttonDownEffectFadeTime > 0f)
                    {
                        GTween.Kill(this, TweenPropType.Scale, true);
                        TweenScale(new Vector2(this.scaleX * _downEffectValue, this.scaleY * _downEffectValue), UIConfig.buttonDownEffectFadeTime);
                    }
                    else
        ...
        override protected void ConstructExtension(ByteBuffer buffer)
        {
            ...
            _clickTranslation = GetTransition("click");
        ...
        override public void Setup_AfterAdd(ByteBuffer buffer, int beginPos)
        {
            ...
            str = GetCustomLocalizedText(buffer.ReadS());
            if (str != null)
                this.title = str;
            str = buffer.ReadS();
            if (str != null)
            ...
            UIUtils.SetupGradientText(GetTextField(), customData);
        }
