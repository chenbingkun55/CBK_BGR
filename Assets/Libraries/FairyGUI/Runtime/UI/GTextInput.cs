...
namespace FairyGUI
{
    ...
    public class GTextInput : GTextField
    {
        ...
        {
            get => inputTextField.promptColor;
            set => inputTextField.promptColor = value;
        }
        ...
        {
            get => inputTextField.textColor;
            set => inputTextField.textColor = value;
        }
        ...
        public override void Setup_BeforeAdd(ByteBuffer buffer, int beginPos)
        {
            ...
            var tfColor = _textField.textFormat.color;
            inputTextField.textColor = tfColor;
            
            const string JsonKey_PROMPT_COLOR = "inputtext_prompt_color";
            var promptColorStr = GetCustomStringProperty(JsonKey_PROMPT_COLOR);

            if (!string.IsNullOrEmpty(promptColorStr) &&
                ColorUtility.TryParseHtmlString(promptColorStr, out var c))
                inputTextField.promptColor = c;
            else
                inputTextField.promptColor = tfColor;
