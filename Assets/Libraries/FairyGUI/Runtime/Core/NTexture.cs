        ...
        public Rect GetDrawRect(Rect drawRect, FlipType flip)
        {
            ...
            switch (flip)
            {
                case FlipType.Horizontal:
                    offsetX = _originalSize.x - _offset.x - _region.width;
                    break;
                case FlipType.Vertical:
                    offsetY = _originalSize.y - _offset.y - _region.height;
                    break;
                case FlipType.Both:
                    offsetX = _originalSize.x - _offset.x - _region.width;
                    offsetY = _originalSize.y - _offset.y - _region.height;
            ...
            return new Rect(offsetX * sx, offsetY * sy, _region.width * sx, _region.height * sy);
        }
